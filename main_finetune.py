...
def get_args_parser():
    ...
    parser.add_argument(
        "--exp", type=str, default="/home/Samar/diffusion_experiments",
    ...
    parser.add_argument('--wandb', type=str, nargs='?', const='mae-diffusion-finetune', default=None,
...
def main(args):
    ...
    dataset_train, dataset_val = get_dataset(args, config)
    ...
    if config.model.type.startswith('unet'):  # args.model_type is not None and args.model_type.startswith('resnet'):
